...
%%
sampling_density = [0.02:0.02:0.2];
repetitions = 5;
epsilon = 0.2;
%% Metrics
...
for h=1:length(folder_challenges)
    ...
    for i=1:length(sampling_density)
        for j=1:repetitions
            path_results_challenge = [pwd,'/../../semi_supervised_learning/default_setting/',...
...
save('../default_setting/results_metrics.mat','recall','specficity','FPR','FNR','PBC','precision',...
