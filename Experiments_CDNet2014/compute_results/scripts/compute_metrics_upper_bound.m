...
%%
recall = cell(length(folder_challenges),1);
specficity = cell(length(folder_challenges),1);
FPR = cell(length(folder_challenges),1);
FNR = cell(length(folder_challenges),1);
PBC = cell(length(folder_challenges),1);
precision = cell(length(folder_challenges),1);
FMeasure = cell(length(folder_challenges),1);
%%
TP = cell(length(folder_challenges),1);
FP = cell(length(folder_challenges),1);
FN = cell(length(folder_challenges),1);
TN = cell(length(folder_challenges),1);
SE = cell(length(folder_challenges),1);
%%
...
save([path_to_results_metrics,'results_metrics.mat'],'recall','specficity','FPR','FNR','PBC','precision',...
    'FMeasure','average_recall','average_specficity',...
